---
title: 'Lower Rio Performance Report BCY 23'
author:  
...
```{r Load Data}
setwd("C:/Users/casasxax/OneDrive - C2/Tableau Extracts/Lower Rio/04.10.23")
...
MEQ2 <- MEQ2 %>% 
    ...
    mutate(Target = case_when(
        Program == "Title I Adult - Local" & `LWDA Number` == 23 ~ 6500,
        Program == "Title I Youth - Local" & `LWDA Number` == 23 ~ 3200,
        Program == "Title I DW - Local" & `LWDA Number`    == 23    ~ 10000,
        TRUE ~ 0),
...
EQ2 <- read_csv("EQ2.csv") %>% 
  ...
  mutate(Target=case_when(
                          `Board ID` == 23 & Program == "Title I Adult - Local"~ 85.00,
...
The data used in creating this report is extracted from **OKTA/Tableau** website. Data is extracted weekly and complied to create this report.
