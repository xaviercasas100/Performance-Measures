---
title: 'Tarrant Performance Report BCY 23'
author:  
...
```{r Load Data}
setwd("C:\\Users\\casasxax\\OneDrive - C2\\Tableau Extracts\\Tarrant")
...
MEQ2 <- MEQ2 %>% 
    ...
    mutate(Target = case_when(
        Program == "Title I Adult - Local" & `LWDA Number` == 5 ~ 6500,
        Program == "Title I Youth - Local" & `LWDA Number` == 5 ~ 3200,
        Program == "Title I DW - Local" & `LWDA Number`    == 5 ~ 9400,
        TRUE ~ 0),
